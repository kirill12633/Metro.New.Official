...
(function() {
    ...
    const DOCS = {
        privacy: { version: '1.5.0', url: 'https://kirill12633.github.io/Metro.New.Official/ru/help/privacy-policy/', name: 'Политика конфиденциальности', icon: '🔒', lastUpdate: '21 апреля 2026 года' },
